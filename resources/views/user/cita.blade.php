      ...
      <form class="main-form"  action="{{url('cita')}}" method="POST">
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight">
            <input type="text" name="correo" class="form-control" placeholder="Direccion de correo Electronico" required="">
          </div>
          ...
          <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
            <input type="text" name="telefono" class="form-control" placeholder="Número" required="" required="">
          </div>
          <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
            <textarea name="mensaje" id="mensaje" class="form-control" rows="6" placeholder="Ingrese mensaje.." required=""></textarea>
          </div>
        </div>
